...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  private readonly defaultOverview: DashboardOverview = {
    ...
    stats: {
      ...
      registeredDirectReferrals: 0,
      activeDirectReferrals: 0,
      inactiveDirectReferrals: 0,
      totalCpvs: 0,
    },
  };
  ...
  private buildStatCardConfigs(): Array<{
    ...
    return [
      ...
      },
      {
        ...
        gradient: bgMuted,
        format: 'number',
        tooltip: 'Paid direct referrals only — registered but unpaid members are excluded.',
      },
      {
        label: 'Registered Members',
        value: stats.registeredDirectReferrals ?? 0,
        icon: 'pi-user-edit',
        gradient: bgMuted,
        format: 'number',
        tooltip: 'People who signed up with your link but have not paid yet.',
      },
      {
        label: 'Active DR',
        value: stats.activeDirectReferrals ?? 0,
        icon: 'pi-check-circle',
        gradient: bgPrimary,
        format: 'number',
        tooltip: 'Paid direct referrals with at least 3 of their own direct referrals.',
      },
      {
        label: 'Inactive DR',
        value: stats.inactiveDirectReferrals ?? 0,
        icon: 'pi-clock',
        gradient: bgMuted,
        format: 'number',
        tooltip: 'Paid direct referrals still building toward 3 direct referrals.',
      },
      {
        label: 'Total CPVs',
